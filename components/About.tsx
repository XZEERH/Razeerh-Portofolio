    ...
    <section id="about" className="py-32 relative w-full container mx-auto px-6 lg:px-20 flex flex-col lg:flex-row items-center justify-center gap-16 min-h-screen">
      ...
      <div className="relative flex-1 flex justify-center items-center w-full h-[500px]">
        ...
        <motion.div 
          ...
          className="bg-[#0a0a0a] border border-white/10 rounded-3xl w-72 md:w-80 p-6 flex flex-col items-center relative z-10 cursor-grab active:cursor-grabbing shadow-2xl mt-[50px]"
        >
          ...
          <div className="w-full h-64 relative rounded-2xl overflow-hidden mb-6 bg-zinc-900 border border-white/5 pointer-events-none">
            <Image src="/images/profile.jpg" alt="RAZEERH" fill className="object-cover grayscale" sizes="300px" />
          </div>
          <h3 className="text-2xl font-bold font-space tracking-tight text-white">RAZEERH</h3>
          <p className="text-white/50 text-sm tracking-wide mt-1 font-inter">{t('about_role')}</p>
